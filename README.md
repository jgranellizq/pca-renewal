...
This repository contains **150 scenario-based exam questions** (75 full PCA Renewal + 75 AI/ML Focus) aligned with:
...
| `questions-ai.json` | AI/ML Focus exam: 75 questions heavily focused on Vertex AI, Gemini, MLOps, and GenAI architectures |
...
| **AI / ML Focus Exam** | `questions-ai.json` | 75 | ~150 min | Vertex AI, Gemini, MLOps, GenAI, Document AI, Vector Search |
...
| 2 | Managing and Provisioning a Solution Infrastructure | 12 |
| 3 | Designing for Security and Compliance | 9 |
| 4 | Analyzing and Optimizing Technical and Business Processes | 14 |
| 5 | Managing Implementation | 9 |
| 6 | Ensuring Solution and Operations Reliability | 5 |
...
| Gemini Long Context Window | Processing entire contracts with Gemini 1.5 Pro / 2.0 Flash |
| Gemini Context Caching | Reducing token costs for static large-prefix prompts |
| Gemini Grounding with Google Search | Reducing hallucinations for current-event facts |
| Vertex AI Agent Builder / Reasoning Engine | Multi-step customer service agents, RAG over enterprise content, multi-agent orchestration |
| Vertex AI Evaluation Service | GenAI output quality measurement (groundedness, coherence, relevance), CI/CD quality gating |
...
| Vertex AI Feature Store | Real-time feature serving for fraud detection, mixed-freshness feature architecture |
...
| Vertex AI Pipelines & MLOps | CI/CD for ML, pipeline-based training, MLOps maturity progression, drift-triggered retraining |
| Vertex AI Model Registry | A/B traffic splitting, model lifecycle governance, model cards |
| Vertex AI Model Monitoring | Feature drift detection, prediction drift alerting |
| Vertex AI Prompt Management | Prompt versioning, lifecycle management, rollback |
| Vertex AI Vizier | Bayesian hyperparameter optimization |
| Vertex AI Imagen | Text-to-image generation for marketing and content creation |
| Vertex AI Model Armor | Prompt injection protection, output safety screening |
...
| BigQuery ML | ARIMA_PLUS forecasting, model export to Vertex AI, ML.GENERATE_EMBEDDING |
| PEFT / LoRA Fine-Tuning | Parameter-efficient fine-tuning for budget-constrained runs |
| TPU vs GPU selection | Compute choice for large-scale LLM training and inference |
...
| Cloud DLP + Vertex AI Pipelines | PII de-identification in ML training data pipelines and fine-tuning data |
...
| RAG Chunking Strategies | Hierarchical parent-child chunking for complete context retrieval |
| Multimodal RAG | Mixed text and image retrieval with multimodal embeddings |
| Shadow Evaluation | LLM model comparison without exposing users to new models |
| Canary Deployment | Traffic-split-based validation of new model versions |
| GenAI Observability | Structured logging, custom metrics, alerting for LLM applications |
| GenAI Incident Response | Rollback procedures and incident management for GenAI regressions |
| AI Tool Selection | Matching the right Google Cloud AI service to each use case |
